...
export const CHANNELS = [
  ...
  "databases.statuses",
  "databases.localPorts",
  "databases.updateLocalPort",
  "databases.copyPasswordToClipboard",
  "databases.copyPasswordUrlEncodedToClipboard",
  "databases.ssoLogin",
  "environment.graphName",
  "errors.subgraphErrors",
  "errors.supergraphErrors",
  "errors.databaseConnectionErrors",
  "logs.read",
  "onboarding.status",
  "onboarding.submitCredentials",
  "onboarding.complete",
  "settings.read",
  "settings.update",
  ...
  "settings.variantFilter",
  "settings.updateVariantFilter",
